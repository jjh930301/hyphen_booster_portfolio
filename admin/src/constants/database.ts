...
export class Database {
  ...
  static BOOSTER_ADMIN : string = process.env.MYSQL_ADMIN_DATABASE ? process.env.MYSQL_ADMIN_DATABASE : 'HYPHEN_BOOSTER_ADMIN';
}

const config = (
  database,
  synchronize : boolean | null = false
...
export const BoosterAdmin : TypeOrmModuleOptions = config(Database.BOOSTER_ADMIN ,false)
