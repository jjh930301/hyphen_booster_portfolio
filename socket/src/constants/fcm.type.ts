...
export class FcmType {
  ...
  static MESSAGE_TYPE : Object = {
    ...
    [FcmType.CARD_APPROVAL] : (
      ...
      return {
        title : "카드 승인" ,
        body : `카드번호 ${data.card_no} | ${data.appr_date} ${data.appr_time} | ${store_name}`,
      }
    },
    [FcmType.CARD_CANCEL_APPROVAL] : (
      ...
      return {
        title : '카드 취소',
        body : `카드번호 ${data.card_no} | ${data.cancel_date} ${data.cancel_time} | ${store_name}`,
      }
    },
    [FcmType.CASH_APPROVAL] : (
      ...
      return {
        title : '현금 승인',
        body : `${data.total_amount} 원 | ${data.appr_date} ${data.appr_time} | ${store_name}`
      }
    },
