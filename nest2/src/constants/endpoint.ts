export class Endpoint {
  ...
  static CORPORATION_BANK_ACCOUNT_INFO = 'in0087000519' // 기업계좌 조회 https://hyphen.im/product-api/view?seq=54
  static CORPORATION_BANK_HISTORY = 'in0087000483' // 기업계좌 거래내역 조회
  ...
  static HELLO_FIN_CHECK_SALSE = 'checksales.ashx';
  static HELLO_FIN_CHECK_STORE = 'checkstore.ashx';
  static HELLO_FIN_ONEDAY_SERVICE = 'registration.ashx';
  static HELLO_FIN_CARD_SALES = 'transactiondata.ashx';
  static HELLO_FIN_DELIVERY_SALES = 'orderdata.ashx';
  static HELLO_FIN_DEPOSIT = 'calculatedata.ashx';
  static HELLO_FIN_ONEDAY_SERVICE_INFO = 'info.ashx';
}